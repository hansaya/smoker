...
#else
static unsigned long preHeatingTime = 1800000; // 30 minutes of pre-heating time
#endif
...
void sendHistory() {
  StaticJsonBuffer<20000> jsonBuffer;                 // Buffer static contenant le JSON courant - Current JSON static buffer
  ...
  char json[20000];                             // Buffer for json output string. This will increase by sizeHist * 166
